...
defmodule Noizu.Entity.Meta.RefIdentifier do
  ...
  def id(m, %{__struct__: m, identifier: R.ref(module: _, identifier: _)} = ref), do: {:ok, ref.identifier}
  ...
  def ref(m, %{__struct__: m, identifier: R.ref(module: _, identifier: _)} = ref), do: {:ok, R.ref(module: m, identifier: ref.identifier)}
  ...
  def sref(m, ref) do
    with sref <- Noizu.Entity.Meta.sref(m),
         ...
         {:ok, inner_sref} <- Noizu.EntityReference.Protocol.sref(inner_ref)
    do
