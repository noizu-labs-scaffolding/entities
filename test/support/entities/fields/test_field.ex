...
defimpl Noizu.Entity.Store.Ecto.EntityProtocol, for: [Noizu.Support.Entity.TestField] do
  defdelegate persist(entity,type,settings,context,options), to: Noizu.Support.Entity.TestField.TypeHelper
  defdelegate as_record(entity,settings,context,options), to: Noizu.Support.Entity.TestField.TypeHelper
  defdelegate as_entity(entity,settings,context,options), to: Noizu.Support.Entity.TestField.TypeHelper
  defdelegate delete_record(entity,settings,context,options), to: Noizu.Support.Entity.TestField.TypeHelper
  defdelegate from_record(record,settings,context,options), to: Noizu.Support.Entity.TestField.TypeHelper
end

defimpl Noizu.Entity.Store.Ecto.Entity.FieldProtocol, for: [Noizu.Support.Entity.TestField] do
  defdelegate field_from_record(field, record, field_settings, persistence_settings, context, options), to: Noizu.Support.Entity.TestField.TypeHelper
  defdelegate field_as_record(field, field_settings, persistence_settings, context, options), to: Noizu.Support.Entity.TestField.TypeHelper
end
